...
export const GET_QUICKLOOK_THUMBNAIL = 'GET_QUICKLOOK_THUMBNAIL';
export const COPY_FILES_TO_CLIPBOARD = 'COPY_FILES_TO_CLIPBOARD';
export const PREVIEW_QUICK_LOOK = 'PREVIEW_QUICK_LOOK';
